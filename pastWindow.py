...
class pastWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        mul = 0.7 # サイズ調整倍率
        self.resize(int(1600*mul), int(950*mul))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(int(30*mul), int(0*mul), int(1100*mul), int(900*mul)))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        spacerItem = QtWidgets.QSpacerItem(int(20*mul), int(270*mul), QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout.addItem(spacerItem)
        
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(int(1230*mul), int(820*mul), int(260*mul), int(80*mul)))
        font = QtGui.QFont()
        font.setFamily("メイリオ")
        ...
        self.groupBox.setGeometry(QtCore.QRect(int(1160*mul), int(40*mul), int(400*mul), int(120*mul)))
        # font = QtGui.QFont()
        # font.setFamily("メイリオ")
        ...
        self.comboBox.setGeometry(QtCore.QRect(int(30*mul), int(40*mul), int(80*mul), int(60*mul)))
        # font = QtGui.QFont()
        # font.setFamily("メイリオ")
        font.setPointSize(9)
        ...
        self.comboBox_2.setGeometry(QtCore.QRect(int(150*mul), int(40*mul), int(70*mul), int(60*mul)))
        # font = QtGui.QFont()
        # font.setFamily("メイリオ")
        font.setPointSize(11)
        ...
        self.comboBox_3.setGeometry(QtCore.QRect(int(260*mul), int(40*mul), int(80*mul), int(60*mul)))
        # font = QtGui.QFont()
        # font.setFamily("メイリオ")
        # font.setPointSize(11)
        ...
        self.label_2.setGeometry(QtCore.QRect(int(110*mul), int(40*mul), int(60*mul), int(60*mul)))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.groupBox)
        self.label_3.setGeometry(QtCore.QRect(int(220*mul), int(40*mul), int(60*mul), int(60*mul)))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.groupBox)
        self.label_4.setGeometry(QtCore.QRect(int(340*mul), int(40*mul), int(60*mul), int(60*mul)))
        self.label_4.setObjectName("label_4")
        self.groupBox_2 = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_2.setGeometry(QtCore.QRect(int(1160*mul), int(180*mul), int(400*mul), int(190*mul)))
        # font = QtGui.QFont()
        # font.setFamily("メイリオ")
        # font.setPointSize(11)
        ...
        self.radioBtn_1.setGeometry(QtCore.QRect(int(30*mul), int(30*mul), int(190*mul), int(70*mul)))
        self.radioBtn_1.setFont(font)
        self.radioBtn_1.setChecked(True)
        
        self.radioBtn_2 = QtWidgets.QRadioButton(self.groupBox_2)
        self.radioBtn_2.setGeometry(QtCore.QRect(int(30*mul), int(70*mul), int(190*mul), int(70*mul)))
        self.radioBtn_2.setFont(font)
        
        self.radioBtn_3 = QtWidgets.QRadioButton(self.groupBox_2)
        self.radioBtn_3.setGeometry(QtCore.QRect(int(30*mul), int(110*mul), int(190*mul), int(70*mul)))
        ...
        self.calendar.setGeometry(QtCore.QRect(int(1160*mul), int(400*mul), int(400*mul), int(350*mul)))
        ...
        self.label.setGeometry(QtCore.QRect(int(1160*mul), int(730*mul), int(400*mul), int(80*mul)))
